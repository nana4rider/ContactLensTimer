package net.nana4.contactlenstimer.models.prefs;
...
public class TimePreference extends DialogPreference {
    ...
    public void updateSummary() {
        ...
        setSummary(getSummaryDate(getContext(), time));
    }
    ...
    public static String getSummaryDate(Context context, String inTime) {
        Date inDate = toDate(inTime);
        if (inDate != null) {
            return android.text.format.DateFormat.getTimeFormat(context).format(inDate);
        } else {
            return inTime;
        }
    }
